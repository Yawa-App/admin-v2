'use client'
import { Home, Users, Shield, MapPin, Building2, Radio, Users2, AirplayIcon as Broadcast, Settings, LogOut, BadgeInfo, Blocks } from 'lucide-react'
            ...
            <div className="space-y-3">
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-none
                  ${isActive("/dashboard") ? 'bg-[#03bde914] text-[#03BDE9]' : 'text-gray-500'} 
                  hover:text-gray-900`}
              >
              ...
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-none 
                  ${isActive("/dashboard/users") ? 'bg-[#03bde914] text-[#03BDE9]' : 'text-gray-500'} 
                  hover:text-gray-900`}
              >
              ...
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-none 
                  ${isActive("/dashboard/safety-circles") ? 'bg-[#03bde914] text-[#03BDE9]' : 'text-gray-500'} 
                  hover:text-gray-900`}
              >
              ...
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-none 
                  ${isActive("/dashboard/states") ? 'bg-[#03bde914] text-[#03BDE9]' : 'text-gray-500'} 
                  hover:text-gray-900`}
              >
              ...
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-none 
                  ${isActive("/dashboard/local-government") ? 'bg-[#03bde914] text-[#03BDE9]' : 'text-gray-500'} 
                  hover:text-gray-900`}
              >
              ...
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-none 
                  ${isActive("/dashboard/admins") ? 'bg-[#03bde914] text-[#03BDE9]' : 'text-gray-500'} 
                  hover:text-gray-900`}
              >
              ...
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-none 
                  ${isActive("/dashboard/customise") ? 'bg-[#03bde914] text-[#03BDE9]' : 'text-gray-500'} 
                  hover:text-gray-900`}
              >
              ...
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-none 
                  ${isActive("/dashboard/settings") ? 'bg-[#03bde914] text-[#03BDE9]' : 'text-gray-500'} 
                  hover:text-gray-900`}
              >
