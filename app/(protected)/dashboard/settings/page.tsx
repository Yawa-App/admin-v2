      ...
      <div className="flex-1 space-y-8 p-8 pt-6">
        ...
        <Tabs defaultValue="general" className="space-y-4">
          <TabsList>
            <TabsTrigger
              value="general"
              className="text-gray-800 active:bg-gray-400"
            >
              General
            </TabsTrigger>
            ...
            <Card className="shadow">
              <form onSubmit={handleSubmit}>
                ...
                <CardFooter>
                  <button
                    type="submit"
                    className="bg-[#03BDE9] px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500"
                  >
                    Save Changes
                  </button>
                </CardFooter>
          ...
          <TabsContent value="notifications">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between text-gray-700">
                  <label className="text-gray-500" htmlFor="push-notifications">
                    Push Notifications
                  </label>
                  <Switch
                ...
                <div className="flex items-center justify-between text-gray-700">
                  <label className="text-gray-500" htmlFor="sms-notifications">
                    SMS Notifications
                  </label>
                  <Switch
                    className="bg-[#03BDE9]"
