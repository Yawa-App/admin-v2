...
} from "@/components/features/app/stateApi";
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-sm/6 text-gray-500">
                    Make sure you input all details before sending an invite.
                ...
                <DialogFooter>
                  ...
                  {isError && (
                    <p className="text-red-500">
                      Failed to invite state. Please try again.
                    </p>
                  )}
                </DialogFooter>
              </DialogContent>
                ...
                currentUsers.map(
                  (user: {
                    ...
                    <TableRow
                      ...
                      onClick={() =>
                        router.push(`/dashboard/states/q?state=${user._id}`)
                      }
                    >
                      <TableCell>
                        <Image
